...
import {sortingProducts} from  '../../utils/functions.js'
import './Product.css'
...
class ProductsContainer extends Component {
  ...
  componentDidMount = () => {
    this.setState({ sortedProducts: sortingProducts(this.props.products, this.props.productSorting) })
  }

  componentDidUpdate = (prevState) => {
    if (prevState.productSorting !== this.props.productSorting || prevState.products !== this.props.products)
      this.setState({ sortedProducts: sortingProducts(this.props.products, this.props.productSorting) })
  }

  // sortingProducts = () => {
  //   return this.props.products.sort((a, b) => {
  //     switch (this.props.productSorting) {
  //       case 'name_min':
  ...
  render() {
    return (
      <div className="all-product">
        {this.props.children}
        {this.state.sortedProducts.map((item) => {
